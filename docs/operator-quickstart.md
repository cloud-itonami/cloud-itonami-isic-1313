# Operator Quickstart — Finishing of textiles

Shortest path from clone to a verified local dry-run for **ISIC 1313** (`cloud-itonami-isic-1313`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1313.git
cd cloud-itonami-isic-1313
```
...
- Blueprint governor key: `textile-finishing-operations-governor`
- Likely source path: `finishingops.governor.cljc`
